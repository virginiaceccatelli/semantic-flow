...
- **FAIL** `swap_is_specific_to_the_value_subspace` — vs logit_value: -0.016 [-0.024, -0.009] (the Jacobian correction, not the unembedding); vs clens_offvalue: +0.150 [+0.117, +0.189] (these values, not the digit subspace at large)
