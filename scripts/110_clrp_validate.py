...
Prerequisites: stage 00 (core.jsonl). No probes, no E13 pairs, no labels.
    ...
    python scripts/110_clrp_validate.py --model deepseek-coder-1.3b
"""
...
def main(
    ...
    output: Optional[Path] = typer.Option(None, help="Default results/clrp/{model}/validate"),
    ...
    from src.experiments.clrp_validate import run_gate_r
    ...
    output = output or Path("results/clrp") / model / "validate"
    ...
    if tables:
        ...
        for name in ("clrp_r2_summary", "clrp_r2_conservation",
                     "clrp_validation_checks", "clrp_r0_forward"):
    ...
    write_manifest("110_clrp_validate", {
