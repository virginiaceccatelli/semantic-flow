...
def main(
    ...
    output: Optional[Path] = typer.Option(None, help="Default results/jlens/{model}/taint"),
    ...
    from src.experiments.jlens_taint import run_jlens_taint
    ...
    output = output or Path("results/jlens") / model / "taint"
    if lens_out:
