...
from src.models.cotangent_lens import LensSample, conservation_ratio
from src.models.cotangent_lrp import is_gated_mlp, lrp_rules, norm_eps_attr
...
def test_empty_install_raises_rather_than_silently_becoming_a_clens():
